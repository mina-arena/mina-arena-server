...
import { Piece, PiecesMerkleTree, Position, Unit, UnitStats } from 'mina-arena-contracts';
...
export default async function serializePiecesTree(gameId, transaction) {
    ...
    gamePieces.forEach(async (gamePiece) => {
        ...
        const snarkyPiece = new Piece(Field(gamePieceNumber), PublicKey.fromBase58(player.minaPublicKey), snarkyPosition, snarkyUnit);
